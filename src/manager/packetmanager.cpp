...
void CUserManager::SendUserLoadout(IUser* user)
{
	...
	// TEMPORARY: Disable Favorite packets to skip crash
	// TODO: Fix packet structure to match 2025 client
	...
	Logger().Info("[LOADOUT] SKIPPED sending Favorite packets (commented out)");
}
